...
Exact candidate `0d952620c20a5881fc9f93c6e64adccb77d87cc3` is dispatched in native ARM64 [run 34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539). Acceptance requires this QuPath-based candidate to pass all native gates.

## Current-pin integration candidate — 2026-09-14

After CLEARSWI advanced the accepted submodule pin to `b878ef4914bed658c8df82cf8d418de21d13315f`, the ARM64 CPU path and timeout commits from the QuPath candidate were replayed onto that accepted pin on [`arm64/vesselboost-clearswi`](https://github.com/Vbitz/neurocontainers/tree/arm64/vesselboost-clearswi). Candidate [`7f191bfa12054f8d56a5296144f263de8dcdef24`](https://github.com/Vbitz/neurocontainers/commit/7f191bfa12054f8d56a5296144f263de8dcdef24) passes recipe validation and ARM64/x86_64 Dockerfile generation. The exact candidate is staged for dispatch after the current QuPath-based native run [34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539) completes; do not accept the older-base result directly.

The QuPath-based candidate `0d952620c20a5881fc9f93c6e64adccb77d87cc3` passed the native ARM64 gates in [run 34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539): Docker/SIF/deploy succeeded and the fulltest passed 46/46 with no skips (47 total checks including deploy). Because that evidence predates the accepted CLEARSWI pin, the exact current-pin replay `7f191bfa12054f8d56a5296144f263de8dcdef24` is dispatched in [run 34792571042](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792571042). Acceptance remains pending that exact run.
