...
- Top-level commit: `16bbd87` (OpenRecon I2I prepared candidate checkpoint)
- Pinned submodule: `neurocontainers@ffe5f289da8da47c006835876a86dcd07138b208`
- Submodule checkout: `arm64/openreconi2iexample`, candidate `56f4fe3ff65556dd51fbea8bde525350d5f15243` from accepted source `ffe5f289da8da47c006835876a86dcd07138b208`; top-level pointer remains at the accepted source, origin `Vbitz/neurocontainers`
...
and awaits a free workflow slot before exact dispatch.
...
| `openreconi2iexample` | candidate `56f4fe3ff65556dd51fbea8bde525350d5f15243` based on accepted source `ffe5f289` | `arm64/openreconi2iexample` | pending slot | no issue yet | ready: validation and both architecture generations passed |
...
- Top-level submodule pointer accepts the tested MNE, SynthStroke, QSMbly, and
  ...
  SynthStrip has a stale run and requires a final replay after current-pin
  integrations. OpenRecon I2I is prepared and awaiting a workflow slot.
...
accepted pin and dispatch its final serial run; dispatch OpenRecon I2I when a
slot opens. Continue screening practical undeclared ports with recorded
preflight blockers.
