...
## Active implementation checkpoint — 2026-09-14 (Syncro fulltest compatibility retry)

- Syncro run [34787372368](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34787372368) built the ARM64 image and SIF successfully and completed 36/37 fulltests. The sole failure was the inherited `mri_synthstrip -d` invocation; FreeSurfer 7.4.1 rejects that unsupported option before execution.
- The three Syncro ARM64 recipe commits were replayed onto accepted pin `b878ef4914bed658c8df82cf8d418de21d13315f` as candidate `54a83518034d8b164ec8290c09a2ee91e42a9996` on `arm64/syncro-clearswi-synthstrip`. The fulltest now uses documented `mri_synthstrip -m` explicit mask output with output and dimension assertions. Validation and ARM64/x86_64 generation pass.
- The exact current-pin candidate is dispatched in [run 34791087179](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34791087179), substantive attempt 4/6 for Syncro. MIMoSA [34787670497](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34787670497) and VesselBoost [34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539) remain active. The local submodule is on the Syncro candidate branch; the top-level pointer remains at accepted `b878ef49` until exact verification succeeds.

## Active implementation checkpoint — 2026-09-14 (current-pin replay queue)

- MIMoSA commits were replayed onto accepted `b878ef4914bed658c8df82cf8d418de21d13315f` as `84cfd4ab2128d5598d3df71685e4d26de46a8fb4` on `arm64/mimosa-clearswi`; validation and ARM64/x86_64 generation pass. Dispatch only if the current MIMoSA run [34787670497](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34787670497) passes, then verify this exact descendant.
- VesselBoost commits were replayed onto accepted `b878ef4914bed658c8df82cf8d418de21d13315f` as `7f191bfa12054f8d56a5296144f263de8dcdef24` on `arm64/vesselboost-clearswi`; validation and ARM64/x86_64 generation pass. Dispatch only if the current VesselBoost run [34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539) passes, then verify this exact descendant.
- Active native jobs are Syncro retry [34791087179](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34791087179), MIMoSA [34787670497](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34787670497), and VesselBoost [34788113539](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34788113539). The local submodule is on the prepared VesselBoost replay branch; the top-level pointer remains at accepted `b878ef49`.

## Active implementation checkpoint — 2026-09-14 (MIMoSA current-pin verification)
...
## Active implementation checkpoint — 2026-09-14 (Blender reopened with explicit user instruction)

- The user’s current instruction explicitly requests implementing all feasible plans, which reopens Blender’s prepared ordinary dependency fix after its earlier six-attempt budget. The complete ARM64 source route was replayed onto accepted `b878ef4914bed658c8df82cf8d418de21d13315f` as `9a08a7f8ee6118f10df406be8ce75f20c2188cce` on `arm64/blender-clearswi`; validation and ARM64/x86_64 generation pass.
- The exact Blender candidate is dispatched in [run 34792723996](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792723996). New bounded window: `2026-09-14T00:26:26Z`–`2026-09-14T12:26:26Z`, attempt 1/6.
- Four native jobs are active: Syncro [34791087179](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34791087179), MIMoSA [34792042542](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792042542), VesselBoost [34792571042](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792571042), and Blender [34792723996](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792723996).

## Active implementation checkpoint — 2026-09-14 (Blender official GMP retry)
...
## Active implementation checkpoint — 2026-09-14 (MIMoSA replay dispatched after Syncro)

- MIMoSA’s b878-based candidate `84cfd4ab2128d5598d3df71685e4d26de46a8fb4` passed native ARM64 build/SIF/deploy and 21/21 fulltests with zero failures or skips in [run 34792042542](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792042542).
- The same recipe commits were replayed onto accepted Syncro pin `54a83518034d8b164ec8290c09a2ee91e42a9996` as `6743ded6ddadc9d5173d2d77a6cc199363ec4f52` on `arm64/mimosa-syncro`; local validation and both architecture generations pass.
- Exact current-pin verification is dispatched in [run 34797053207](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797053207), attempt 2/6. Active native work remains VesselBoost [34792571042](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792571042), Blender [34794572307](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34794572307), and MIMoSA replay [34797053207](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797053207). The top-level pointer remains accepted at `54a83518` pending exact replay verification.

## Active implementation checkpoint — 2026-09-14 (VesselBoost replay dispatched after Syncro)

- VesselBoost’s b878-based candidate `7f191bfa12054f8d56a5296144f263de8dcdef24` passed native ARM64 build/SIF/deploy and 47/47 fulltests with zero failures or skips in [run 34792571042](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34792571042).
- The intended recipe commits were replayed onto accepted Syncro pin `54a83518034d8b164ec8290c09a2ee91e42a9996` as `863c447457d817156882b12a6920fd3411f68543` on `arm64/vesselboost-syncro`; local validation and both architecture generations pass.
- Exact current-pin verification is dispatched in [run 34797274474](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797274474), attempt 2/6. Active native work is MIMoSA [34797053207](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797053207), VesselBoost replay [34797274474](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797274474), and Blender [34794572307](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34794572307). The top-level pointer remains accepted at `54a83518` pending exact replay verification.

## Active implementation checkpoint — 2026-09-14 (Blender OSL CPU configuration retry)

- Blender attempt 4 [34794572307](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34794572307) reached the native OSL dependency configure after roughly 77 minutes, then failed because Blender 5.0.1 forced `-DOSL_USE_OPTIX=ON` while the ARM64 CPU image had no CUDA toolkit.
- Candidate `49e180d828f5e7c19826d9ce959db346bf3825ed` on `arm64/blender-syncro` applies the ARM64-only source configuration `-DOSL_USE_OPTIX=OFF`, preserving CPU Cycles and the x86_64 path. Local recipe validation and both architecture generations pass.
- Exact Blender attempt 5/6 is dispatched in [run 34799068941](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34799068941). MIMoSA replay [34797053207](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797053207) and VesselBoost replay [34797274474](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797274474) remain active. The top-level pointer remains accepted at `54a83518`.

## Active implementation checkpoint — 2026-09-14 (post-VesselBoost replay queue)

- VesselBoost candidate `863c447457d817156882b12a6920fd3411f68543` passed native ARM64 Docker/SIF/deploy and 47/47 fulltests in [run 34797274474](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797274474), and root acceptance commit `135eb79` advanced the top-level submodule pin to that exact SHA. Coverage issue #2 was refreshed with Actions still disabled.
- MIMoSA’s prior-pin replay [34797053207](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34797053207) then completed with 21/21 tests. Its intended commits were replayed onto accepted VesselBoost pin `863c4474` as candidate `df8a470aa8f1d5c45ffe2ac43fe39193a11e05d1` on `arm64/mimosa-vesselboost`; validation and ARM64/x86_64 generation pass. The exact current-pin candidate is dispatched in [run 34802537055](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34802537055), attempt 3/6 for MIMoSA.
- Blender’s targeted OSL CPU configuration retry [34799068941](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34799068941) remains active from the prior accepted pin. The complete Blender route was replayed onto accepted VesselBoost pin `863c4474` as candidate `839f7259751913129a2d292591c3b5d9fc55f5eb` on `arm64/blender-vesselboost`; validation and ARM64/x86_64 generation pass. Dispatch this exact candidate only after run 34799068941 completes; do not run two Blender attempts concurrently.
- Checkpoint time: `2026-09-14T03:25:57Z`. Current accepted submodule SHA: `863c447457d817156882b12a6920fd3411f68543`. Local submodule branch: `arm64/blender-vesselboost`; root pointer is intentionally unstaged until an exact current-pin candidate passes. Next actions: review runs 34802537055 and 34799068941, dispatch the prepared Blender descendant when its older run completes, then integrate any passing candidate serially and continue through all remaining feasible plans.

## Active implementation checkpoint — 2026-09-14 (Blender Flex path retry)

- Blender attempt 5 [34799068941](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34799068941) confirmed OSL configured with OptiX and CUDA disabled, and the bundled Flex dependency compiled and installed. The build then failed because OSL's release CMake could not find `/opt/build_linux/deps_arm64/Release/flex`; the first actionable error was `FLEX is required, aborting`.
- Candidate `f096bb4b0a3cc2a4fde90ab957770ea79dfac722` on `arm64/blender-vesselboost` passes local recipe validation and ARM64/x86_64 generation after adding ARM64-only `-DFLEX_ROOT=${LIBDIR}/flex` to the OSL configuration. Final Blender attempt 6/6 is dispatched in [run 34803823363](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34803823363). MIMoSA exact replay [34802537055](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34802537055) remains active.
- Current accepted submodule SHA remains `863c447457d817156882b12a6920fd3411f68543`; root pointer is intentionally unstaged until exact current-pin verification passes. Next action: review both active runs, integrate any exact passing candidate serially, and otherwise record the concrete Blender blocker after this final targeted attempt.

## Active implementation checkpoint — 2026-09-14 (MIMoSA accepted; Blender replay prepared)

- MIMoSA candidate `df8a470aa8f1d5c45ffe2ac43fe39193a11e05d1` passed native ARM64 Docker/SIF/deploy and 21/21 fulltests with zero failures or skips in [run 34802537055](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34802537055). It was accepted serially as the top-level submodule pin in root commit `b9b988a`; coverage issue #2 was refreshed with Actions still disabled.
- Blender’s final candidate `f096bb4b0a3cc2a4fde90ab957770ea79dfac722` is still running from the prior accepted pin in [run 34803823363](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34803823363); do not use that result for acceptance after the pin advanced. Its complete intended recipe commits were replayed onto accepted MIMoSA pin `df8a470aa8f1d5c45ffe2ac43fe39193a11e05d1` as candidate `09402f8976c33558bcc5e1009e95e81b1dd715be` on `arm64/blender-mimosa`. Local validation and ARM64/x86_64 generation pass, and the branch is pushed.
- Dispatch the exact Blender MIMoSA descendant after run 34803823363 completes so two Blender attempts are never concurrent. Acceptance requires its complete native Docker/SIF/deploy/fulltest gates; a deep upstream source error closes Blender as blocked-upstream.
- Current accepted submodule SHA: `df8a470aa8f1d5c45ffe2ac43fe39193a11e05d1`. Local submodule branch: `arm64/blender-mimosa`; root pointer is intentionally unstaged until the exact current-pin Blender candidate passes.

## Active implementation checkpoint — 2026-09-14 (Blender MaterialX Xt dependency retry)
...
- The stale corrected integration run [34910314613](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34910314613) completed with native build/SIF/deploy success and **121/121 fulltests**. It is recipe evidence for the earlier BrainLesion pin only; current-pin run `34910862134` is now active for final acceptance.

## TractSeg acceptance checkpoint — 2026-09-15
...
## AIDAmri compiler-selection retry checkpoint — 2026-09-15
...
## AIDAmri runtime-fix retry checkpoint — 2026-09-15
...
## Neurocommand verification checkpoint — 2026-09-15

- The previously prepared Apptainer ARM64 source-build change `438050de3f8e251edf8a6f8ae454e15731e15984` was replayed onto the current accepted pin `04970417e995232706f4ce85ddf4db23c79d4f25` as `d374656887d77c959e710b8a773f7b37925bb41b` on `arm64/neurocommand-current`.
- Recipe validation and regenerated ARM64 and x86_64 Dockerfiles pass. The candidate preserves the x86_64 Apptainer package and builds Apptainer 1.4.4 from source on ARM64 with Go 1.23.6.
- Earlier dispatches failed before job creation; the current workflow has since completed native jobs successfully. Push and dispatch the exact candidate SHA, then require build, SIF, deploy and fulltest evidence before accepting it. Keep the accepted pin unchanged meanwhile.
- Exact native dispatch: run [34928349450](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34928349450), recorded in [issue #158](https://github.com/Vbitz/neurocontainers-arm64/issues/158#issuecomment-5674669205). The accepted pin remains unchanged while this run is queued.

## Neurocommand ARM64 retry checkpoint — 2026-09-15

- Run [34928349450](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34928349450) failed after the ARM64 Apptainer source build, during the Miniconda solve: `datalad-0.9.3` requires `git-annex`, which is unavailable in the Linux AArch64 Conda channel. The image's native Ubuntu `git-annex` install succeeded, so this is a recipe packaging failure rather than an Apptainer portability blocker. Issue [#158](https://github.com/Vbitz/neurocontainers-arm64/issues/158#issuecomment-5674720522) records the first actionable error and attempt 1 outcome.
- Candidate `e74050df0e4881833ae5d8d82b4e0ef287a14179` keeps the x86_64 Conda Datalad path and installs ARM64 Datalad from PyPI after the ARM Conda solve. Recipe validation and both architecture generations pass. This is attempt 2/6 in the reopened neurocommand window; dispatch the exact candidate and require Docker build, SIF conversion, deploy checks and fulltest before accepting it. The accepted pin remains `04970417e995232706f4ce85ddf4db23c79d4f25`.
- Exact candidate dispatch created native ARM64 run [34928959233](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34928959233) at 2026-09-15T04:28:25Z. The workflow head is root checkpoint `44114bd1757fabc37c14b79469da8112ccdd4fac`; the run's recipe source metadata must be checked to confirm candidate `e74050df0e4881833ae5d8d82b4e0ef287a14179`. Do not change the accepted pin while this run is active.
- Run [34928959233](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34928959233) passed the exact candidate: native ARM64 Docker build, SIF conversion, deploy checks and **3/3 fulltests** all succeeded with zero failures and zero skips. Issue [#158](https://github.com/Vbitz/neurocontainers-arm64/issues/158#issuecomment-5674814307) records the verified outcome. The candidate descends directly from accepted pin `04970417e995232706f4ce85ddf4db23c79d4f25`; integrate the submodule pointer serially, then refresh coverage issue [#2](https://github.com/Vbitz/neurocontainers-arm64/issues/2). The overall goal remains active.

## GOUHFI infrastructure retry checkpoint — 2026-09-15

- GOUHFI's two earlier native ARM64 attempts reached a completed Docker image but failed during Docker-to-SIF export with `no space left on device`; no application or architecture failure was observed. Later native runs, including neurocommand run [34928959233](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34928959233), completed the same export path, so one fresh unchanged retry is justified. Issue [#60](https://github.com/Vbitz/neurocontainers-arm64/issues/60) and [plans/gouhfi.md](plans/gouhfi.md) record the reopened window.
- Investigation starts `2026-09-15T04:43:14Z` and ends `2026-09-15T16:43:14Z`; attempt 1 in the reopened window. Dispatch exact accepted source `e74050df0e4881833ae5d8d82b4e0ef287a14179`, require SIF/deploy/fulltest, and stop if the storage blocker recurs. The overall goal remains active.
- Exact dispatch created native ARM64 run [34929965852](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34929965852) at `2026-09-15T04:44:10Z`. The run remains active in the native build/SIF phase; the accepted pin is unchanged pending deploy and fulltest evidence.

## GOUHFI retry result — 2026-09-15
