...
- TopoFit retry `34778828330` passed the Ninja check but failed at Cortech's Meson configure because `pkg-config` was missing. Candidate `88e6776aeb27f16ef43e015acb426b7e87fe0d1c` adds it and is dispatched as exact run [34779394328](https://github.com/Vbitz/neurocontainers-arm64/actions/runs/34779394328), attempt 3/6; issue [#236](https://github.com/Vbitz/neurocontainers-arm64/issues/236#issuecomment-5655748876) records the hypothesis and stop boundary.
